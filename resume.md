...
* **Data Analysis & SQL:** Executed complex queries in SQL to extract, clean, and analyze financial services data, uncovering key trends and insights.
* **Strategic Recommendations:** Translated analytical findings into actionable insights that guided business decisions and supported strategic initiatives.
* **Executive Visualization:** Created clear, compelling visual narratives to present results and recommendations to senior leadership.
...
**William & Mary** | *Williamsburg, VA* **B.A. Economics, Minor in Data Science, Master’s in Business Analytics** | *Expected May 2027* * **Honors:** Dean's List, Elks Scholar  
...
## 🛠 Skills & Interests
* **Technical:** SQL, Python, JavaScript, ArcGIS, QGIS, Microsoft Excel (Advanced), Tableau/Visualization
* **Certifications:** Spanish (Basic proficiency)
* **Activities:** Sigma Alpha Epsilon, History Club, National Honor Society
* **Interests:** Drone Photography, Baking, Sneakers, Biking
